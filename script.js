...
const defaultGalleryData = [
  ...
  },
  {
    "id": 2,
    "image": "images/2.jpg",
    "promptText": "Fotografi realistik, full-body portrait pasangan muda (wanita di kiri, pria di kanan) berdiri berdampingan di zebra crossing area parkir basement mall dijakarta modern. Pencahayaan alami siang hari dari atas menyinari wajah dan tubuh secara merata, suasana cerah namun indoor. Wanita: wajah mirip seperti gambar referensi, hijab instan putih polos rapi menutupi dada (jersey premium tidak transparan), turtleneck putih lengan panjang ketat, jaket denim crop biru muda (kancing metal, saku dada, ujung lengan terlipat), celana cargo putih high-waist longgar dengan banyak saku (katun tebal), sneakers Nike putih logo hitam. Tangan kiri di pinggang, tangan kanan rileks. Ekspresi tersenyum ramah, mata tajam menatap kamera, alis tebal natural, kulit cerah. Pria: wajah mirip seperti gambar referensi, rambut hitam rapi. Hoodie hitam merek Air Jordan dengan logo Air Jordan putih di sisi kanan, celana jeans hitam panjang, sneakers Nike Jordan Retro 4 Oreo putih-hitam sedikit warna putih. Tangan disilang di dada (jari jelas terlihat). Ekspresi cool, sedikit tersenyum tipis, mata tajam, kulit sawo matang, dagu tegas. Latar belakang: lantai beton abu-abu bersih, sedikit pantulan cahaya. Mobil terparkir: Toyota Fortuner VRZ biru tua (kanan, plat BM 15 BOD), Mitsubishi Pajero hitam (tengah), BMW putih seri 3/4 (kanan, plat B 16 BOS). Pilar beton abu-abu di tengah. Lampu neon putih dari langit-langit dan cahaya alami dari ventilasi atas. Gaya: Portrait couple Instagram influencer, kasual tapi stylish. Sudut pengambilan: Eye level (setinggi dada), sedikit wide shot agar full body masuk frame, seperti diambil dari drone kamera yang sedang terbang dengan kedua objek melihat ke atas ke arah kamera drone. Jarak kamera: 3-4 meter. Lensa: 35mm-50mm. Depth of field: F/2.8-F/4 (subjek tajam, background bokeh ringan). Pencahayaan: Top light + fill light alami, tanpa bayangan keras di wajah. Warna: Natural, saturasi sedang, kontras seimbang, tone hangat. Resolusi: 4K, detail tajam pada tekstur kain, sablon, dan ekspresi wajah. NEGATIVE PROMPT: buram, noise, kartun, animasi, terlalu gelap, overexposed, tangan rusak, jari tambahan, wajah buram, pakaian kusut, latar terlalu ramai, efek filter berlebihan, watermark. dan buatkan pose gaya foto lebih menarik."
  }
];
